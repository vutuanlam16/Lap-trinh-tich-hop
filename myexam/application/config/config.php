...
$config['smtp_hostname'] = "email-smtp.us-east-1.amazonaws.com"; // smtp hostname eg. ssl://smtp.gmail.com
$config['smtp_username'] = "AKIAI5VSLGQD7SHCT5AA"; // smtp username
$config['smtp_password'] = "AiY0z22t8jqAuTwMqK8jAP3oBJs5W4KEWiC26i4fkyYk"; // smtp password
$config['smtp_port'] = "587";// smtp outgoing port. eg for gmail its 465, outlook 587, yahoo 465 for other contact your mailing administrator
$config['smtp_timeout'] = "5";// smtp timeout default 5 seconds
$config['fromemail']="contact@lazyweb.vn";// email send from
$config['fromname']="LazyWeb Contact";// from name
