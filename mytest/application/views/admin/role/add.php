                ...
                <div class="tab-content">
                    <div id="home" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="form-field-1-1" name="name" value="" class="form-control" />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="control-group">
                                            <div class="checkbox">
                                                <label>
                                                    <!-- menu cha -->
                                                    <input name="menu_id[]" value="<?php echo $row['id']; ?>" type="checkbox" class="ace" />
                                                    ...
                                                    <?php if($row['menu_action_array']): ?>
                                                        <?php foreach($row['menu_action_array'] as $aItemSetting): ?>
                                                            <div class="checkbox">
                                                                <label>
                                                                    |---&nbsp;<input type="checkbox" class="ace" name="actions[<?php echo  $row['id']; ?>][]" value="<?php echo $aItemSetting['key_setting'] ?>">
                                            ...
                                            <?php if($row['menu_list_sub']): ?>
                                               ...
                                               <?php foreach($row['menu_list_sub'] as $aItemMenuRoleAdd2): ?>
                                                ...
                                                <div class="checkbox">
                                                    <label>
                                                        <!-- menu con  -->
                                                        |---&nbsp;<input name="menu_id[]" value="<?php echo $aItemMenuRoleAdd2['id']; ?>" type="checkbox" class="ace" >
                                                        ...
                                                        <?php if($aItemMenuRoleAdd2['menu_action_array']): ?>
                                                            <?php foreach(($aItemMenuRoleAdd2['menu_action_array']) as $aItemSetting): ?>
                                                                <div class="checkbox">
                                                                    <label>
                                                                        |---&nbsp;<input type="checkbox" class="ace" name="actions[<?php echo  $aItemMenuRoleAdd2['id']; ?>][]" value="<?php echo $aItemSetting['key_setting'] ?>"> 
                                                                        <span class="lbl"><?php echo $aItemSetting['value'] ?></span>
                                                                    </label>
                                                                </div>
                                                            <?php endforeach; ?>
