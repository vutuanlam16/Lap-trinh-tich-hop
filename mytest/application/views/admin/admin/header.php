<div class="breadcrumbs" id="breadcrumbs">
    ...
    <div class="col-xs-4">
        <div style="float: right;">
           ...
           <button type="button" onclick="location.href = '<?php echo admin_url('admin/add');?>'" class="btn btn-sm btn-danger">
             <span class="glyphicon glyphicon-plus"></span> Thêm mới 
         </button>
         <button type="button" onclick="location.href = '<?php echo admin_url('admin');?>'" class="btn btn-sm btn-danger">
